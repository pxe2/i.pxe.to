...
<<<<<<< HEAD
<<<<<<< HEAD
curl -O http://d5cc1d780d46.pouliot.net/coreos/cloud-config.yml/coreos-alpha-amd64.cloud-config.yml
=======
curl -O http://615f95e47bea.pouliot.net/coreos/cloud-config.yml/coreos-alpha-amd64.cloud-config.yml
