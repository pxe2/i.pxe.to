...
<<<<<<< HEAD
<<<<<<< HEAD
curl -O http://d5cc1d780d46.pouliot.net/coreos/cloud-config.yml/coreos-beta-amd64.cloud-config.yml
=======
curl -O http://615f95e47bea.pouliot.net/coreos/cloud-config.yml/coreos-beta-amd64.cloud-config.yml
...
# apply cloud config
sudo coreos-cloudinit -validate --from-file ./coreos-beta-amd64.cloud-config.yml
sudo coreos-cloudinit --from-file ./coreos-beta-amd64.cloud-config.yml
