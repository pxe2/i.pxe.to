...
<<<<<<< HEAD
<<<<<<< HEAD
wget http://d5cc1d780d46.pouliot.net/rancheros/cloud-config.yml/rancheros-1.2.0-amd64.cloud-config.yml
=======
wget http://615f95e47bea.pouliot.net/rancheros/cloud-config.yml/rancheros-1.2.0-amd64.cloud-config.yml
...
sudo ros config validate -i ./rancheros-1.2.0-amd64.cloud-config.yml
sudo ros config merge -i ./rancheros-1.2.0-amd64.cloud-config.yml
