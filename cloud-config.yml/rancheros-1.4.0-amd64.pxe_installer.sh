...
<<<<<<< HEAD
<<<<<<< HEAD
wget http://d5cc1d780d46.pouliot.net/rancheros/cloud-config.yml/rancheros-1.4.0-amd64.cloud-config.yml
=======
wget http://615f95e47bea.pouliot.net/rancheros/cloud-config.yml/rancheros-1.4.0-amd64.cloud-config.yml
...
#sed -i "/ discovery: \"https://discovery.etcd.io/<token>\"/c\ $DISCOVERY" ./rancheros-1.4.0-amd64.cloud-config.yml
